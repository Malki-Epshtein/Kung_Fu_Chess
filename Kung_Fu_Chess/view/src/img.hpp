...
public:
    ...
    /**
     * Deep copy - unlike the default copy constructor (which shares the
     * underlying cv::Mat buffer), this returns an independent image safe
     * to mutate without affecting the original.
     */
    Img clone() const;
